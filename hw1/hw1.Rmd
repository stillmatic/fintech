...
**e** Let's consider verification status, grade, and revolving balance. We're going to do this on test-train split as well.

```{r}
fit_larger <- glm(default ~ fico + revol_util + grade + verification_status, data = data_out, family = "binomial")
